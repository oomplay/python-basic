...
OSshow1 = ('1. Neofetch on Ubuntu & Debian');OSshow2 = ('2. Google Chrome on Linux');OSshow3 = ('3. Uninstall Neofetch Ubuntu & Debian');OSshow4 = ('4. Uninstall CentOS');OSshow5 = ('5. openSUSE')
